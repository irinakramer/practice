...
// Robot that picks a random direction
...
//console.log(randomPick([1, 2, 3, 4, 5]));

// static method to add 'random' to VillageState class
...
console.log(runRobot(VillageState.random(), routeRobot, [])); // faster than the random robot
